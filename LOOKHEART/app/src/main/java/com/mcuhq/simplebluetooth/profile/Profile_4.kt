...
class Profile_4 : Fragment() {
    var lTx: MutableList<String> = ArrayList()
    private val sharedViewModel: SharedViewModel? = null
    private var e_ecg = false
    private var e_manual = false
    private var esent = false
    private var psent = false
    private var asent = false
    private var bsent = false
    private var b1sent = false
    private var b2sent = false
    private var b3sent = false
    private var e_x = 0
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_profile4, container, false)
        val btn1 = view.findViewById<Button>(R.id.profile4_ECGMODE)
        val btn2 = view.findViewById<Button>(R.id.profile4_PEAKMODE)
        val btn3 = view.findViewById<Button>(R.id.profile4_AUTO)
        val btn4 = view.findViewById<Button>(R.id.profile4_MANUAL)
        val btn5 = view.findViewById<Button>(R.id.profile4_X0_5)
        val btn6 = view.findViewById<Button>(R.id.profile4_X1)
        val btn7 = view.findViewById<Button>(R.id.profile4_X2)
